...
const HabitDetails = () => {
  ...
  if (!habit) return <p className="text-center mt-10 text-gray-700 dark:text-gray-300">Habit not found</p>;
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 p-4 md:p-6 lg:p-8">
      <div className="card bg-white dark:bg-gray-900 shadow-xl dark:shadow-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden transition-all duration-300">
          ...
          {habit.image && (
            <div className="shrink-0 w-full md:w-1/2 h-64 md:h-auto">
              <img
                src={habit.image}
                alt={habit.title}
                className="w-full h-[500px] object-cover rounded-xl shadow-md dark:shadow-gray-700"
              />
            </div>
          )}

          <div className="flex flex-col justify-start space-y-4 w-full md:w-1/2 text-gray-800 dark:text-gray-200">
            <h1 className="text-3xl md:text-4xl font-bold">{habit.title}</h1>
            ...
            <div className="relative group inline-block">
              <p className="leading-relaxed text-base md:text-lg">
                {habit.description.length > 150 ? habit.description.slice(0, 150) + "..." : habit.description}
              </p>
            ...
            <div className="mt-6">
              <button
                ...
                className={`px-5 py-2 rounded-lg shadow text-white transition-all duration-300 ${
